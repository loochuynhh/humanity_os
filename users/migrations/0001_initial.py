    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fixed_location', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checkin_location', models.CharField(blank=True, max_length=100, null=True)),
                ('checkout_location', models.CharField(blank=True, max_length=100, null=True)),
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('user', 'date'), name='unique_checkin_checkout_per_day')],
            },
        ),
    ]
